...
export const artists: Artist[] = [
  {
    ...
    bio: 'Abriu o estúdio em 2014 depois de dez anos rodando convenções pelo Nordeste. Trabalha com preto e cinza pesado, sombreado profundo e coberturas que ninguém achava que dava pra salvar.',
  ...
  },
  {
    ...
    bio: 'Traço fino levado ao limite: folhagens, insetos e composições delicadas que envelhecem bem. Desenha tudo à mão antes de encostar a máquina na pele.',
  ...
  },
  {
    ...
    bio: 'Contorno grosso, paleta fechada e aquele humor de flash antigo. Mantém uma pasta de desenhos prontos pra quem quer sair tatuado no mesmo dia.',
  ...
  },
  {
    ...
    bio: 'Geometria sagrada, mandalas e ponto a ponto com paciência de relojoeiro. Projeta cada peça em cima da anatomia de quem vai usar.',
